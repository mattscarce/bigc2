    ...
    try:
        ...
        try:
            if (req.json()["status_code"] == 0):
                ...
                TotalSendedShare += 1
                if DebugMode == True:
                    print(Colorate.Horizontal(Colors.cyan_to_blue, f"Sent Share: {TotalSendedShare}|Successfully!"))
                else:
                    print(Colorate.Horizontal(Colors.blue_to_cyan, f"Sent Share: {TotalSendedShare}| Successfully! "))
            else:
                pass
        except:
            TotalFailedReq += 1
...
if (__name__ == "__main__"):
   ...
   ██████╔╝███████╗██████╔╝███████╗╚██████╔╝██║░░██║
   ╚═════╝░╚══════╝╚═════╝░╚══════╝░╚═════╝░╚═╝░░╚═╝
          credits to dedlur, join his discord
